  ...
  useEffect(() => {
    ...
    function update(t: number) {
      ...
      const {
        ...
        enableMouseInteraction: currentMouseInteraction,
      } = propsRef.current;
      program.uniforms.uColor.value[0] = currentColor[0];
      program.uniforms.uColor.value[1] = currentColor[1];
      program.uniforms.uColor.value[2] = currentColor[2];
      program.uniforms.uAmplitude.value = currentAmplitude;
      program.uniforms.uDistance.value = currentDistance;

      if (currentMouseInteraction) {
